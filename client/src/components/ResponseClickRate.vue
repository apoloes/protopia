    ...
    export default {
        ...
        methods: {
          setChartData: function() {
            ...
            for (var i = 0; i < this.cleanData.cleanResponseData.clickRate.length; i++) {
              var dataObject = {
                label: this.cleanData.cleanResponseData.clickRate[i].status,
                value: this.cleanData.cleanResponseData.clickRate[i].count
              };
