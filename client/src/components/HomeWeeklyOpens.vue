    ...
    export default {
        ...
        methods: {
          setChartData: function() {
            ...
            let pastWeek = 0;
            for (let i = 1; i < 8; i++) {
                pastWeek = pastWeek + this.cleanData.cleanFullData.opensCount[i].counts;
            }
            let dataObject = {
                label: "Last Week",
                value: pastWeek,
            ...
            let currWeek = 0;
            for (let i = 8; i < 15; i++) {
                currWeek = currWeek + this.cleanData.cleanFullData.opensCount[i].counts;
            }
            ...
            if(this.HomeWeeklyChartData.data[0].value > this.HomeWeeklyChartData.data[1].value){
                ...
                this.HomeWeeklyChartData.annotations.groups[0].items[1].text = "Decrease in Opens";
            }else{
