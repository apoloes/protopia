        ...
        methods: {
            setChartData: function() {
              ...
              if (this.time == "today") {
                ...
                this.dailyResponseRateChartData.chart.subcaption = "Last Week";
              }
